...
def decodeImage(imgstring, fileName):
    ...
    try:
        # Print for debugging
        print(f"Received image string length: {len(imgstring)}")
        print(f"Image string starts with: {imgstring[:50]}")
        ...
        print(f"Decoded image data length: {len(imgdata)}")
        ...
        print(f"Error in decodeImage: {str(e)}")
